...
NotebookDataLength[    256580,       4905]
NotebookOptionsPosition[    257122,       4902]
NotebookOutlinePosition[    257536,       4920]
CellTagsIndexPosition[    257493,       4917]
WindowFrame->Normal*)
...
Electric Quadrupole and Higher-Order Multipole Angular Spectra", 
       ...
       Hold[
        Style[
         TextCell[
         "This applet allows users to compute and display directly the \
angular spectrum representation of any electromagnetic multipole field. It is \
designed to be flexible and easy to use, with a layout wrapping two different \
workspaces. First tab enables the first multipolar orders, i.e., electric \
...
magnetic-like Hertz potentials of any arbitrary order {\[ScriptL],\[ScriptM]} \
and their corresponding electromagnetic multipole fields.", TextJustification -> 
          1], 12, TextAlignment -> Left]], 
       Manipulate`Dump`ThisIsNotAControl}, {
       Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Style[
...
$CellContext`dirEM = CreateDirectory[]; $LocalBase = $CellContext`dirEM; 
                   Row[{
                    Manipulate`Place[81], 
                    Manipulate`Place[82], 
                    Manipulate`Place[83], "                 ", 
                    ...
                    DeleteDirectory[$CellContext`dirEM, DeleteContents -> 
                    True], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Ex_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ToString[
                    If[$CellContext`s$$ > 0, "_upper", "_lower"]], ".png"]]; 
                    Export[
                    LocalObject["figures"], $CellContext`contourplotE2, 
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Ey_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Ez_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    If[$CellContext`s$$ > 0, "_upper", "_lower"]], ".png"]]; 
                    DeleteFile[
                    StringJoin[$CellContext`dirEM, "/figures/object.wl"]]; 
                    Null], 
                    Which[$CellContext`plotHfield$$ == True, Export[
                    LocalObject["figures"], $CellContext`contourplotH1, 
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Hx_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Hy_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Hz_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Es_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Ep_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Hs_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "PNG"]; RenameFile[
                    StringJoin[$CellContext`dirEM, "/figures/export"], 
                    StringJoin[$CellContext`dirEM, "/figures/Hp_l_", 
                    ToString[$CellContext`l0$$], 
                    ToString["_m_"], 
                    ToString[$CellContext`m0$$], 
                    ToString["_z"], 
                    ...
                    "Figures are saved in the following folder:", Null, 
                    Hyperlink[
                    Style[$CellContext`dirEM, Bold], 
                    StringJoin["file://", $CellContext`dirEM, "/figures"], 
                    ActiveStyle -> {Red}]}]]]; Null, Appearance -> 
                    "Palette"]}, 
                    Spacer[20]], 
                   Row[{
     ...
     1598., {22., 27.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`asrdipole$1112$$ = 
     False, $CellContext`asrSource$1117$$ = False, $CellContext`s$1118$$ = 
     False, $CellContext`plotEfield1$1119$$ = 
     False, $CellContext`plotHfield1$1120$$ = 
     False, $CellContext`qualityplotpointsdipole$1121$$ = 
     False, $CellContext`asrmultipole$1122$$ = 
     False, $CellContext`electriclikeSOURCE$1123$$ = 
     False, $CellContext`basis$1124$$ = False, $CellContext`axis$1125$$ = 
     False, $CellContext`simplify$1126$$ = 
     False, $CellContext`plotEfield$1127$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`asrdipole$$ = 
         ...
         Hold[$CellContext`asrdipole$$, $CellContext`asrdipole$1112$$, False], 
         Hold[$CellContext`asrSource$$, $CellContext`asrSource$1117$$, False], 
         Hold[$CellContext`s$$, $CellContext`s$1118$$, False], 
         Hold[$CellContext`plotEfield1$$, $CellContext`plotEfield1$1119$$, 
          False], 
         Hold[$CellContext`plotHfield1$$, $CellContext`plotHfield1$1120$$, 
          False], 
         Hold[$CellContext`qualityplotpointsdipole$$, \
$CellContext`qualityplotpointsdipole$1121$$, False], 
         Hold[$CellContext`asrmultipole$$, $CellContext`asrmultipole$1122$$, 
          False], 
         Hold[$CellContext`electriclikeSOURCE$$, \
$CellContext`electriclikeSOURCE$1123$$, False], 
         Hold[$CellContext`basis$$, $CellContext`basis$1124$$, False], 
         Hold[$CellContext`axis$$, $CellContext`axis$1125$$, False], 
         Hold[$CellContext`simplify$$, $CellContext`simplify$1126$$, False], 
         Hold[$CellContext`plotEfield$$, $CellContext`plotEfield$1127$$, 
          False]}, 
       "OtherVariables" :> {
        ...
        If[$CellContext`m0$$ >= 0, 
          If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$, $CellContext`m0$$, 0] == 
              0, $CellContext`\[CapitalPi]lmxLimit = Normal[
                 Limit[
...
$CellContext`finString = Last[
                 ...
                 ToExpression[
                    ...
                    ToString[$CellContext`\[CapitalPi]lmxLimit, 
                    StandardForm], {$CellContext`iniString, \
$CellContext`finString}], "\)"]]]], $CellContext`\[CapitalPi]lmxLimit = Normal[
                  Limit[
...
$CellContext`WaveVectorAssumptions], $CellContext`\[CapitalPi]elmxVector = 0]; 
          If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$, $CellContext`m0$$, 0] == 
              0, $CellContext`\[CapitalPi]lmyLimit = Normal[
                 Limit[
...
$CellContext`finString = Last[
                 ...
                 ToExpression[
                    ...
                    ToString[$CellContext`\[CapitalPi]lmyLimit, 
                    StandardForm], {$CellContext`iniString, \
$CellContext`finString}], "\)"]]]], $CellContext`\[CapitalPi]lmyLimit = Normal[
                  Limit[
...
$CellContext`WaveVectorAssumptions], $CellContext`\[CapitalPi]elmyVector = 0]; 
          If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$ - 1, $CellContext`m0$$, 0] == 
              0, $CellContext`\[CapitalPi]lmzLimit = Normal[
                 Limit[
...
$CellContext`finString = Last[
                 ...
                 ToExpression[
                    ...
                    ToString[$CellContext`\[CapitalPi]lmzLimit, 
                    StandardForm], {$CellContext`iniString, \
$CellContext`finString}], "\)"]]]], $CellContext`\[CapitalPi]lmzLimit = Normal[
                  Limit[
...
$CellContext`WaveVectorAssumptions], $CellContext`\[CapitalPi]elmzVector = 0],
           If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$, 
              ...
              0, $CellContext`\[CapitalPi]lmxccLimit = Normal[
                 Limit[
...
$CellContext`WaveVectorAssumptions], $CellContext`\[CapitalPi]elmxVector = 0]; 
          If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$, 
                Abs[$CellContext`m0$$], 0] == 
              0, $CellContext`\[CapitalPi]lmyccLimit = Normal[
                 Limit[
...
$CellContext`WaveVectorAssumptions], $CellContext`\[CapitalPi]elmyVector = 0]; 
          If[$CellContext`l0$$ >= Abs[$CellContext`m0$$], 
            If[LegendreP[$CellContext`l0$$ - 1, 
                Abs[$CellContext`m0$$], 0] == 
              0, $CellContext`\[CapitalPi]lmzccLimit = Normal[
                 Limit[
...
Quadrupole and Higher-Order Multipole Angular Spectra (2019)."], Bold, 16, 
                 Blue]}], 
              Column[{
                Style[
...
Quadrupole and Higher-Order Multipole Angular Spectra (2019)."], Bold, 16, 
                 Lighter[Blue, 0.3]]}]], 
             NotebookLocate[{
               URL["https://doi.org/XX.XXXX/PhysRev.XXX.XXXXXX"], None}], 
...
\[Phi] -> ArcTan[$CellContext`kx, $CellContext`ky], $CellContext`kR -> 
 ...
 CellChangeTimes->{{3.766314350980339*^9, 3.766314361589686*^9}},
 CellLabel->"Out[1]=",ExpressionUUID->"2ed7bbf0-bffc-45e7-9d72-211d61acf3eb"]
},
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 255630, 4867, 365, "PluginEmbeddedContent",ExpressionUUID->"2ed7bbf0-bffc-45e7-9d72-211d61acf3eb"]
}
]
*)
...
(* NotebookSignature jw02EptMwtVOYCgx@ysGidvI *)
